...
| Configuration | Pydantic Settings loading `.env`; tracked `.env.example`; separate validated official-discovery, Source-fetch, and snapshot byte-limit policies |

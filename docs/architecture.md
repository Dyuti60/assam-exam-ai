...
| API | FastAPI app with health, internal create Source/Evidence/Claim/Verification, Claim-to-Evidence linking, and retrieve Evidence/Claim/Verification endpoints under `/api/v1` |
...
| Tests | Nineteen tests cover the foundation, provenance constraints, end-to-end knowledge API, Evidence and Claim retrieval, Claim evidence linking, and failure atomicity |
